...
export default class Methods {
	...
	*/
	"void" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "void", [], __options , (result) => { return handleReturnType(result, getTypeDescription(0, 'auction')); });
	}
